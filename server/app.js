...
app.get('/rooms/:roomid/ratings', (req, res) => res.redirect(`http://${ms1}/rooms/${req.params.roomid}/ratings`));

// app.get('/rooms/:roomid/reviews', (req, res) => res.redirect('http://18.219.35.229:80/rooms/' + req.params.roomid + '/reviews'));
app.get('/rooms/:roomid/reviews', (req, res) => res.redirect(`http://${ms1}/rooms/${req.params.roomid}/reviews`));
